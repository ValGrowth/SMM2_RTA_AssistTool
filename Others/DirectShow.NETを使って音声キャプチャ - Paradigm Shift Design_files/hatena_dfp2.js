...
hatenadfp.displayAds = function() {
    for (var i = 0; i < hatenadfp.adUnits.length; i++) {
        ...
        if (hatenadfp._dgMatchedSegments && hatenadfp._dgMatchedSegments.length > 0) {
            adSlot.setTargeting('dg_segments', hatenadfp._dgMatchedSegments);
        }
    }
...
hatenadfp._addScript('http://ox-d.hatena.servedbyopenx.com/w/1.0/jstag?nc=4374287-hatena.ne.jp');
